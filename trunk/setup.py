...
Pyvol provides an easy way for researchers to share and compare volatility estimation approaches. A researcher can subclass the {{{CovEstimator}}} class in {{{pyvol.est.CovEst}}} and use pyvol to evaluate performance and compare to other estimators. 
